...
class ussdParkingPayment extends StatefulWidget {
  const ussdParkingPayment({Key? key}) : super(key: key);

  @override
  _ussdParkingPaymentState createState() => _ussdParkingPaymentState();
}

class _ussdParkingPaymentState extends State<ussdParkingPayment> {
          ...
          child: Container(
            ...
            child: Column(
              ...
              children: <Widget>[
                ...
                Center(child: Text('Dial the code below to complete parking fee with your Bank')),
                const SizedBox(
                  height: 20,
                ),
