...
class customer_verification extends StatefulWidget {
  const customer_verification({Key? key}) : super(key: key);

  @override
  _customer_verificationState createState() => _customer_verificationState();
}

class _customer_verificationState extends State<customer_verification> {
  ...
  Future <String>  Customer_OTP_Verification() async {
    ...
    String url = "https://app.prananet.io/LaspaApp/Api/customer_verification";
    ...
    if(message.contains("OTP Matched")){
                        ...
                        child: Column(
                          ...
                          children: <Widget>[
                            FadeAnimation(1.3, Padding(
                              ...
                              child:  Text('kindly enter the OTP sent to', style: TextStyle(fontSize: 16),),
                            )),
