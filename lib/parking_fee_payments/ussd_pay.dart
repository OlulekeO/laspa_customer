...
class fee_payment_ussd extends StatefulWidget {
  const fee_payment_ussd({Key? key}) : super(key: key);

  @override
  _fee_payment_ussdState createState() => _fee_payment_ussdState();
}

class _fee_payment_ussdState extends State<fee_payment_ussd> {
  ...
  Future getEmail()async{
   ...
   customerUssdPayment() async {
    ...
    String url = "https://app.prananet.io/LaspaApp/Api/customer_ussd_parkpayment";
            ...
            child: Container(
              ...
              child: Form(
                ...
                child: Column(
                  ...
                  children: <Widget>[
                    Text("Pay with USSD",style: TextStyle(fontSize: 20, fontWeight: FontWeight.bold),),
                    const SizedBox(
                      height: 40,
                    ),
